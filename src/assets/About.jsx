    ...
    <>
      <motion.main initial={{ y: 50, scale: 0.8, opacity: 0 }}
        ...
        <div className='w-full lg:w-[50%] order-1 lg:order-1 p-2 text-center lg:text-start  '>
          ...
          <h5 className='text-white text-2xl lg:text-3xl font-medium'>We provide services related to </h5>
          <h6  style={{ minHeight: "40px" }} className='text-[#4ff1d8] text-2xl lg:text-3xl my-4 font-medium'>
            <Typewriter
